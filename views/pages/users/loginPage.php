...
<h3 class="text-center my-4">Connectez-vous</h3>


<form action="<?= ROOT ?>compte/login" method="POST">
    <div class="row justify-content-center">
        <div class="col-12 col-md-9 col-lg-6">
            ...
            <button class="btn btn-success my-3 w-100" type="submit">Je me connecte</button>
            <a href="<?= ROOT ?>compte/enregistrement" class="btn btn-info w-100 my-3">Je n'ai pas de compte</a>
        </div>
    </div>
</form>